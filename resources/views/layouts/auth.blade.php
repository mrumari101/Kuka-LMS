...
<head>
    ...
    <!-- ===============================================--><!--    Document Title--><!-- ===============================================-->
    <title>Kuka-LMS | Login</title>

    <!-- ===============================================--><!--    Favicons--><!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="falcon/img/favicons/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="falcon/img/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="falcon/img/favicons/favicon-16x16.png">
    <link rel="shortcut icon" type="image/x-icon" href="falcon/img/favicons/favicon.ico">
    <link rel="manifest" href="falcon/img/favicons/manifest.json">
    <meta name="msapplication-TileImage" content="falcon/img/favicons/mstile-150x150.png">
