...
<nav class="navbar navbar-light navbar-vertical navbar-expand-xl" style="display: none;">
    ...
    <div class="d-flex align-items-center">
        <div class="toggle-icon-wrapper">
            ...
            <div class="d-flex align-items-center py-3"><img class="me-2" src="{{asset('falcon/images/falcon.png')}}" alt="" width="40" /><span class="font-sans-serif text-primary">falcon</span></div>
        </a>
    </div>
                            ...
                            <a class="nav-link {{ request()->routeIs('admin.levels.*') ? 'active' : '' }}"
                               href="{{ route('admin.levels.index') }}">
                                ...
                                <span class="nav-link-icon">
                                    ...
                                    <span class="nav-link-text ps-1">Levels</span>
                                </div>
                            </a>
                        </li>
                        @endrole
                            ...
                            <a class="nav-link {{ request()->routeIs('admin.chapters.*') ? 'active' : '' }}"
                               href="{{ route('admin.chapters.index') }}">
                                ...
                                <span class="nav-link-icon">
                                    ...
                                    <span class="nav-link-text ps-1">Chapters</span>
                                </div>
                            </a>
                        </li>
                        @endrole
                            ...
                            <a class="nav-link {{ request()->routeIs('admin.topics.*') ? 'active' : '' }}"
                               href="{{ route('admin.topics.index') }}">
                                ...
                                <span class="nav-link-icon">
                                    ...
                                    <span class="nav-link-text ps-1">Topics</span>
                                </div>
                            </a>
                        </li>
                        @endrole
...
{{--                        <div class="text-center"><img src="falcon/images/navbar-vertical.png" alt="" width="80" />--}}
